      ...
      <section className="w-full pt-12 md:pt-24 lg:pt-32 border-bottom-b">
        <div className="px-4 md:px-6 space-y-10 xl:space-y-16">
          <div className="grid max-w-[1300px] mx-auto gap-4 px-4 sm:px-6 md:px-10 md:grid-cols-2 md:gap-16">
            <div>
              <h1 className="lg:leading-tighter text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl xl:text-[3.4rem] 2xl:text-[3.75rem] font-sans">
                Discover the Latest Fashion Trends
              </h1>
            </div>
            <div className="flex flex-col items-start space-y-4">
              <p className="mx-auto max-w-[700px] text-muted-foreground md:text-xl">
                Explore our curated collections of stylish apparel and accessories for
                every occasion.
              </p>
              <div className="flex flex-col w-full md:flex-row gap-2 text-nowrap">
                <Link
                  to="/search/womens-collection"
        ...
        <div className="container space-y-12 px-4 md:px-6">
          ...
          <div className="mx-auto grid items-start justify-center gap-8 sm:max-w-4xl sm:grid-cols-2 md:gap-12 lg:max-w-5xl lg:grid-cols-4">
            <div className="grid gap-1">
              <Link to="/search/womens-collection" className="group">
                <img
            ...
            <div className="grid gap-1">
              <Link to="/search/mens-collection" className="group">
                <img
            ...
            <div className="grid gap-1">
              <Link to="/search/kids" className="group">
                <img
            ...
            <div className="grid gap-1">
              <Link to="/search/sales" className="group">
                <img
